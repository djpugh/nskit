            ...
            root: {
                root / "src": {
                    root / "src" / src_path: {
                        ...
                        root / "src" / src_path / "_version.py": None,
                        root / "src" / src_path / "recipe.py": None,
                        root / "src" / src_path / "ingredient.py.jinja": None,
                    }
                },
                root / "tests": {
                    root / "tests" / "unit": {root / "tests" / "unit" / "test__version.py": None},
                    root / "tests" / "functional": {root / "tests" / "functional" / ".git-keep": ""},
                    root / "tests" / "integration": {root / "tests" / "integration" / ".git-keep": ""},
                    root / "tests" / "performance": {root / "tests" / "performance" / ".git-keep": ""},
                    root / "tests" / "smoke": {root / "tests" / "smoke" / ".git-keep": ""},
                },
