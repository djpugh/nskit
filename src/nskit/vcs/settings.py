...
from nskit.vcs.providers._base import VCSProviderSettings, ProviderEnum
from nskit.vcs.repo import NamespaceValidationRepo, ValidationEnum
...
class SDKSettings(BaseConfiguration):
