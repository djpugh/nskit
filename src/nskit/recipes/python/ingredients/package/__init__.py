...
taskfiles_folder.contents += [
    File(
        ...
        content='nskit.recipes.python.ingredients.package:taskfiles.python_package.yml.jinja'
    )
]

taskfile = File(
    name='Taskfile.yml',
    content='nskit.recipes.python.ingredients.package:Taskfile.yml.jinja'
)
