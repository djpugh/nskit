...
test_dir = Folder(
    ...
    contents=[
        ...
        Folder(name="functional", contents=[File(name=".git-keep", content="")]),
        Folder(name="integration", contents=[File(name=".git-keep", content="")]),
        Folder(name="performance", contents=[File(name=".git-keep", content="")]),
        Folder(name="smoke", contents=[File(name=".git-keep", content="")]),
    ],
)
